 ...
 *
 * Source file: /Users/bendyer/Projects/ARM/workspace/vectorcontrol/dsdl/thiemar/equipment/esc/11034.Status.uavcan
 */
...
struct UAVCAN_EXPORT Status_
{
        ...
        , esc_index()
    {
         ...
         */
        ::uavcan::StaticAssert<149 == MaxBitLen>::check();
#endif
    }
...
{
    ::uavcan::DataTypeSignature signature(0x7EF3CBEDAFD6E00CULL);
...
void YamlStreamer< ::thiemar::equipment::esc::Status >::stream(Stream& s, ::thiemar::equipment::esc::Status::ParameterType obj, const int level)
{
    ...
    s << "acceleration: ";
    YamlStreamer< ::thiemar::equipment::esc::Status::FieldTypes::acceleration >::stream(s, obj.acceleration, level + 1);
    s << '\n';
    for (int pos = 0; pos < level; pos++)
    {
        s << "  ";
