 ...
 *
 * Source file: /mnt/hgfs/workspace/libuavcan/dsdl/uavcan/protocol/dynamic_node_id/1.Allocation.uavcan
 */
...
# 0.007%), nodes that are requesting dynamic allocations need to be able to handle them correctly. Hence, a collision
...
# Random intervals should be chosen anew per transmission.
#
