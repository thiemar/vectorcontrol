 ...
 *
 * Source file: /mnt/hgfs/workspace/libuavcan/dsdl/uavcan/protocol/6.AccessCommandShell.uavcan
 */
...
#
# Exit status of the last executed process, 0 by default.
#
...
#
# In case of a shell error, this string will contain ASCII string explaining the nature of the error.
