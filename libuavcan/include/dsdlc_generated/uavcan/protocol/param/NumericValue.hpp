 ...
 *
 * Source file: /mnt/hgfs/workspace/libuavcan/dsdl/uavcan/protocol/param/NumericValue.uavcan
 */
...
Empty empty                     # First field is always the default one, so the value is empty by default
