 ...
 *
 * Source file: /mnt/hgfs/workspace/libuavcan/dsdl/uavcan/protocol/2.GetDataTypeInfo.uavcan
 */
...
uint8[<=80] name            # Full data type name; valid only if the data type is known (see FLAG_KNOWN)
******************************************************************************/
