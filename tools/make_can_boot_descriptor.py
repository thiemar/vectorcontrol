...
if __name__ == "__main__":
    ...
    parser.add_option("--bootloader-size", dest="bootloader_size", default=0,
                      help="pad the bootloader image to SIZE bytes",
                      metavar="SIZE")
    parser.add_option("--bootloader-image", dest="bootloader_image", default=0,
                      help="prepend a bootloader image to the output file",
                      metavar="IMAGE")
    parser.add_option("--application-skip", dest="application_skip", default=0,
                      help="skip the first SIZE bytes of the application image",
                      metavar="SIZE")
